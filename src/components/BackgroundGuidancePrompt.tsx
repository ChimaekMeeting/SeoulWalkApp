...
/**
 * 산책 시작 시 화면 상단에 뜨는 1회성 제안 배너 — "화면을 꺼도 안내받기"를 켤지 물어본다.
 * WalkInProgressScreen이 백그라운드 위치 권한이 아직 없을 때만 띄우고, "나중에"를 누르면 그
 * 산책에서는 다시 안 띄운다(다음 산책에서는 다시 물어봄 — 매번 강제하지 않되 스팸도 안 되게).
 * 거부해도 화면 켜진 동안의 턴바이턴 안내(Phase A)는 그대로 동작한다.
 */
